...
Use unsupervivsed learning and Amazon SageMaker skills by clustering cryptocurrencies and creating plots to present your results.
...
Load the information about cryptocurrencies and perform data preprocessing tasks.  You can choose one of the following methods to load the data:
